...
kairos-cli_URL := https://github.com/kairos-io/provider-kairos/releases/download/$(AGENT_PROVIDER_VERSION)/kairos-cli-$(AGENT_PROVIDER_VERSION)-Linux-$(ARCH).tar.gz
